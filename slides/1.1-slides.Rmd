...
.center[
![:scale 65%](../images/micro_website_s22.png)
...
- .hi[Possible Room Change]

- Teaching Assistant(s): TBD
  - grade HWs & hold office hours

- See the [resources page](http://microS22.classes.ryansafner.com/resources) for tips for success and more helpful resources
]
]
