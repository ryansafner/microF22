---
title: "4.1 — Consequences and Causes of Market Power"
...
# 4.1 — Consequences & Sources of Power
...
$$C(q)=cq$$
  - No fixed costs; $\color{red}{MC(q)}=\color{orange}{AC(q)} = c$<sup>.magenta[†]</sup>
...
- If this industry were **competitive**, firms would set $\color{blue}{p_c}=\color{red}{MC(q)}$ and (collectively), industry would produce $q_c$
  - Max’d .blue[consumer surplus], $\color{green}{\pi=0}$

.footnote[<sup>.magenta[†]</sup> Why? [See here](/content/2.5-content/#common-cost-assumptions) for a reminder.]
]
...
.pull-left[
.center[
![:scale 70%](../images/io_hex.png)
]
]

.pull-right[

- More about antitrust in my [Industrial Organization course](https://ios20.classes.ryansafner.com/):
