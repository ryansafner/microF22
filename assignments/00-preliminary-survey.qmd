...
<p style="text-align:center"><a target="_blank" href="/files/assignment/00-preliminary-survey-pdf.pdf"><span class="btn btn-primary btn-lg"><i class="fas fa-file-pdf"></i> Download PDF</a></span></p>
