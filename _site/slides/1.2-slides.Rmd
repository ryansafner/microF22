...
### [Opportunity Cost](#31)
### [Changes in Market Conditions](#39)
...
- .hi[Rational choice theory]: assume that they .hi[optimize] within constraints
...
- .hi-turquoise[*Everyone* is “a consumer”]
  - "Goods and services" aren't just food, clothing, etc, but *anything* that you value! (free time, friendship, reputation, etc.)
...
.footnote[<sup>.magenta[†]</sup> See [appendix](content/1.2-content/#math-appendix) in today's class page to extend to *n* goods!]
...
- **Slope**: .hi-purple[tradeoff] between $x$ and $y$ at market prices
  - Market .hi-purple[“exchange rate”] between $x$ and $y$: $\frac{p_x}{p_y}y:1x$
