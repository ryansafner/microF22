...
$$\epsilon_{q,p} = \color{#e64173}{\frac{\Delta q}{\Delta p}} \times \color{#44C1C4}{\frac{p}{q}}$$
...
4. At what price is demand unit elastic (i.e. $\epsilon_{q,p} = -1)$?
...
| Unit Elastic $\vert \epsilon \vert = 1$ | R **maximized** |
| Inelastic $\vert \epsilon \vert < 1$ | p & R change **together** |
...
.hi-purple[Revenue max'ed at price where `\\(\epsilon = - 1\\)`]
]
