...
- .hi-red[Budget constraint]: individual’s **constraints** of income and market prices
  ...
  - .red[.ul[Marginal cost]] (of good $x$, in terms of $y)$
...
- .hi-green[Utility function]: individual’s **objective** to maximize, based on their preferences
  ...
  - .green[.ul[Marginal benefit]] (of good $x$, in terms of $y)$
]
]
.pull-right[
.center[
...
.footnote[<sup>.magenta[†]</sup> See the [mathematical appendix](/resources/appendices/1.4-appendix) in today's class notes on how to solve it with calculus, and an example.]
...
.smallest[
$$\begin{align*}
\color{#047806}{\text{indiff. curve slope}} &> \color{#D7250E}{\text{budget constr. slope}} \\
\end{align*}$$
]
]
...
$$\begin{align*}
\color{#047806}{\text{indiff. curve slope}} &> \color{#D7250E}{\text{budget constr. slope}} \\
\color{#047806}{\frac{MU_x}{MU_y}} &> \color{#D7250E}{\frac{p_x}{p_y}} \\
\color{#047806}{2} &> \color{#D7250E}{0.5} \\\end{align*}$$
...
\color{#047806}{\text{indiff. curve slope}} &< \color{#D7250E}{\text{budget constr. slope}} \\
\color{#047806}{\frac{MU_x}{MU_y}} &< \color{#D7250E}{\frac{p_x}{p_y}} \\
\color{#047806}{0.125} &< \color{#D7250E}{0.5} \\\end{align*}$$
...
.smallest[
$$\begin{align*}
\color{#047806}{\text{indiff. curve slope}} &= \color{#D7250E}{\text{budget constr. slope}} \\\end{align*}$$
]
...
\color{#047806}{\text{indiff. curve slope}} &= \color{#D7250E}{\text{budget constr. slope}} \\
\color{#047806}{\frac{MU_x}{MU_y}} &= \color{#D7250E}{\frac{p_x}{p_y}} \\
\color{#047806}{0.5} &= \color{#D7250E}{0.5} \\\end{align*}$$
